...
def build(stats: dict, skin_key: str) -> str:
    ...
    spotlight_items = [
        ...
        ("「充裕未来」系列 (1/2/3代及盈尚)", "储蓄人寿", "英式分红 (复归+终期)", "第 4~8 年+", "91.5%", "81%~162%", "历经市场洗礼的经典英式分红王牌，最高达162%，展现长线高权益资产的爆发力"),
        ("「年金宝」入息计划", "年金计划", "周年红利", "第 7~11 年+", "85.0%", "77%~111%", "跨越十年的经典退休年金，经历多次经济大周期，持续派发稳定现金流"),
